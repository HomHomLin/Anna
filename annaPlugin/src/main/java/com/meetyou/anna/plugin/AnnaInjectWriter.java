...
public class AnnaInjectWriter {
    ...
    public byte[] inject(String clazz, boolean needAnnotation){
        ...
        {
            mv = cw.visitMethod(Opcodes.ACC_PUBLIC, "onIntercept", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Z", null, null);
            mv.visitCode();
            Label l0 = new Label();
            Label l1 = new Label();
            Label l2 = new Label();
            ...
            mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
            mv.visitVarInsn(Opcodes.ALOAD, 0);
            mv.visitFieldInsn(Opcodes.GETFIELD, clazz, "mOnIntercept", "Ljava/lang/reflect/Method;");
            Label l4 = new Label();
            ...
            mv.visitFieldInsn(Opcodes.PUTFIELD, clazz, "mOnIntercept", "Ljava/lang/reflect/Method;");
            mv.visitLabel(l4);
            mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
            mv.visitVarInsn(Opcodes.ALOAD, 0);
            mv.visitFieldInsn(Opcodes.GETFIELD, clazz, "mOnIntercept", "Ljava/lang/reflect/Method;");
        ...
        {
            mv = cw.visitMethod(Opcodes.ACC_PUBLIC, "onMethodEnter", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;", null, null);
            mv.visitCode();
            Label l0 = new Label();
            Label l1 = new Label();
            Label l2 = new Label();
